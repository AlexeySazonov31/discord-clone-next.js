...
const roleIconMap = {
  ...
  ADMIN: <ShieldAlert className="h-4 w-4 text-rose-700" />,
};
            ...
            <div key={member.id} className="flex items-center gap-x-2 mb-6">
              ...
              <div className="flex flex-col gap-y-1">
                <div className="text-xs font-semibold flex items-center gap-x-1">
                  {/null/.test(member.profile.name) ? member.profile.email : member.profile.name}
              ...
              {server.profileId !== member.profileId && loadingId !== member.id && (
                <div className="ml-auto">
                  <DropdownMenu>
                    <DropdownMenuTrigger className="text-zinc-500 focus:outline-none focus:text-zinc-900 focus:scale-105">
