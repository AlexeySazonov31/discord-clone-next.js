...
const ServerChannel = ({ channel, server, role }: ServerChannelProps) => {
  ...
  return (
    <button
      onClick={onClick}
      className={cn(
        "group px-2 py-2 rounded-md flex items-center gap-x-2 w-full hover:bg-zinc-700/5 dark:hover:bg-zinc-700/50 transition mb-1",
    ...
    >
      ...
      >
        {limitLengthFirstWord(channel.name, 14)}
      </p>
